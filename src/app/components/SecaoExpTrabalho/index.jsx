import estilos from './SecaoExp.module.css';
import Card from '@/app/components/Card/card';


export default function SecaoExp(props) {
    return (
        <section className={props.ehTemaEscuro ? estilos.secaoExp_modo_escuro : estilos.secaoExp_modo_claro}>
            <div className={estilos.container_texto}>
                <h2>Experiências de Trabalho</h2>
                <p>Há mais de 10 anos no mercado de Branding, Design Gráfico, Criação de Sites e Marketing Digital,
